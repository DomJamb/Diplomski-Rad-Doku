...
Pritom postoji nekoliko čestih opasnosti: napadi umetanjem stražnjih vrata~\cite{gao2020backdoor} i prisutnost zašumljenih oznaka~\cite{gupta2019dealing}.\ 
...
Skup podataka bio je podijeljen na minigrupe veličine $128$.\ U slučaju nadziranog učenja s konzistencijskim gubitkom, koristili smo konstantnu stopu konzistencije iznosa $1$.\ 
...
Skup podataka ponovno je bio podijeljen na minigrupe veličine $128$.\ Koristili smo konstantnu stopu konzistencije iznosa $1$.\
...
\begin{table}[htb]
  ...
  CE & 83.80 & 57.20 & 27.30 \\
  CE + CL & 95.40 & 91.70 & 76.20 \\ \hline
...
Dok standardno nadzirano učenje ovdje postiže nisku točnost iznosa $57.20\%$, dodavanjem konzistencijskog gubitka istu možemo povećati na $91.70\%$.\ 
...
Kod ovog postava, nadzirano učenje postiže veoma nisku točnost iznosa $27.30\%$.\ Iako dodavanjem konzistencijskog gubitka točnost možemo povećati za čak $48.90\%$, ovaj rezultat je i dalje značajno lošiji od rezultata okvira VIBE.\ 
...
Uočimo da povećavanjem stope šuma s $20\%$ na $80\%$ kod okvira VIBE gubimo samo $1.3\%$ točnosti, dok kod algoritama SOP+ te ILL gubimo $3.15\%$ odnosno $2.47\%$ točnosti.\ 
...
Kao i prije, stupac \textit{Točnost [\%]} predstavlja točnost naučenog modela na čistom skupu za ispitivanje skupa CIFAR-10, a najbolji rezultat je podebljan.\ 
...
Vidimo da u ovom slučaju okvir VIBE postiže najvišu točnost.\ Pritom je točnost okvira VIBE za $1.36\%$ viša u odnosu na algoritam SOP+, odnosno za $9.35\%$ viša u odnosu na algoritam ILL.\ 
...
Dodatno, vidimo da i u ovom slučaju dodavanje konzistencijskog gubitka nadziranom učenju značajno povećava točnost.\ Konkretno, ovdje postižemo povećanje točnosti iznosa $15.4\%$.\ 
...
Pritom jake augmentacije uključuju slabe augmentacije te augmentaciju AutoAugment, a stopa konzistencije je postavljena na iznos $1$.\ Pogledajmo kako se točnost modela učenih okvirom VIBE s konzistencijskim gubitkom mijenja ovisno o broju iteracija učenja te iznosu stope učenja.\ 
...
U sljedećim eksperimentima, podrazumijevamo učenje okvirom VIBE s konzistencijskim gubitkom i stopom konzistencije iznosa $1$.\ 
...
U prethodnim eksperimentima, stopu konzistencije smo fiksirali na iznos $1$.\ Pogledajmo sada kako se točnost modela učenih okvirom VIBE s konzistencijskim gubitkom mijenja ovisno o iznosu stope konzistencije.\ 
U tablici~\ref{tbl:usporedba_con_rate}, stupac \textit{Stopa konzistencije} predstavlja korištenu (konstantnu) stopu konzistencije, dok stupac \textit{Točnost [\%]} ponovno predstavlja točnost naučenog modela na čistom skupu za ispitivanje skupa CIFAR-10.\ 

\begin{table}[htb]
  \caption{Točnost modela učenih okvirom VIBE s konzistencijskim gubitkom ovisno o stopi konzistencije.}
  \label{tbl:usporedba_con_rate}
  \centering
  \begin{tabular}{l||c}
  Stopa konzistencije & Točnost [\%] \\ \hline \hline
  0.1 & 94.8 \\
  0.25 & 94.8 \\
  0.5 & 94.8 \\
  0.75 & 94.9 \\
...
Kao što možemo vidjeti, model učen uz stopu konzistencije iznosa $7.5$ postiže najvišu točnost jednaku $95.7\%$.\ 
...
Kao i za stopu učenja, i za stopu konzistencije možemo definirati strategiju izmjene iznosa stope.\ 
...
Konkretno, možemo definirati strategiju linearnog rasta stope konzistencije.\ Naravno, pritom moramo definirati i početni te konačni iznos stope.\
Usporedimo sada korištenje konstantne stope konzistencije s korištenjem strategije linearnog rasta stope uz različite početne odnosno konačne iznose.\ 
U tablici~\ref{tbl:usporedba_con_rate_scheduler}, stupac \textit{Strategija izmjene} predstavlja korištenu strategiju izmjene stope konzistencije.\ 
Pritom vrijednost \textit{Konstantna, 7.5} označava strategiju konstantne stope iznosa $7.5$, a vrijednost \textit{Linearna, [0.1, 10]} označava strategiju linearnog rasta stope od početnog iznosa $0.1$ do konačnog iznosa $10$.\ 

\begin{table}[htb]
  \caption{Točnost modela učenih okvirom VIBE s konzistencijskim gubitkom ovisno o strategiji izmjene stope konzistencije.}
  \label{tbl:usporedba_con_rate_scheduler}
  \centering
  \begin{tabular}{l||c}
  Strategija izmjene & Točnost [\%] \\ \hline \hline
  Konstantna, 7.5 & \textbf{95.7} \\
  Linearna, [0.1, 1] & 95.0 \\
  Linearna, [0.1, 5] & 95.1 \\
  Linearna, [0.1, 10] & 95.3 \\
  Linearna, [1, 5] & 95.2 \\
  Linearna, [1, 7.5] & 95.2 \\
  Linearna, [1, 10] & 95.4 \\
  \end{tabular}
...
Vidimo da model učen uz konstantnu stopu konzistencije iznosa $7.5$ postiže najvišu točnost.\ 
Dakle, korištenje strategije linearnog rasta stope konzistencije vodi do smanjenja točnosti naučenih modela.\ 
...
Potaknuti tom činjenicom, u skup jakih augmentacija smo dodali augmentaciju nasumičnog brisanja.\ Pogledajmo sada kako se točnost modela učenih okvirom VIBE s augmentacijom nasumičnog brisanja mijenja ovisno o iznosu stope konzistencije.\ 

\begin{table}[htb]
  \caption{Točnost modela učenih okvirom VIBE s augmentacijom nasumičnog brisanja ovisno o stopi konzistencije.}
...
Možemo vidjeti da modeli učeni uz stopu konzistencije iznosa $2.5$ odnosno iznosa $5$ postižu najvišu točnost jednaku $95.7\%$.\ 
Iako je točnost ovih modela jednaka točnosti prethodno najboljeg modela iz tablice~\ref{tbl:usporedba_con_rate}, konačna točnost uz većinu drugih iznosa stope konzistencije je sada viša.\ 
Zbog toga, odlučujemo se za uključivanje augmentacije nasumičnog brisanja u skup jakih augmentacija.\ Dodatno, stopu konzistencije fiksiramo na iznos $5$.\ 

Dodavanjem novih augmentacija u postojeći skup augmentacija povećavamo sveukupnu jačinu skupa.\ Kako bi utjecaj konzistencijskog gubitka bio otprilike jednak kao i prije, potrebno je smanjiti iznos stope konzistencije.\ 
Ovo možemo vidjeti i u prethodnim eksperimentima: dodavanjem augmentacije nasumičnog brisanja, iznos optimalne stope konzistencije se smanjuje sa $7.5$ na $5$.\ 

Konačno, pogledajmo ovisi li optimalan iznos stope konzistencije o konkretnoj inačici skupa podataka.\ U tablici~\ref{tbl:usporedba_con_rate_razl_skupovi}, svaki stupac iz grupe stupaca \textit{Inačica skupa podataka} predstavlja jednu inačicu skupa CIFAR-10.\ 
...
\begin{table}[htb]
  \caption{Točnost modela učenih okvirom VIBE s konzistencijskim gubitkom na različitim inačicama skupa CIFAR-10 ovisno o stopi konzistencije.}
  \label{tbl:usporedba_con_rate_razl_skupovi}
  \centering
  \begin{tabular}{l||ccc}
  & \multicolumn{3}{c}{Inačica skupa podataka} \\ \hline
  Stopa konzistencije & Čisto & Simetrično, 20\% & Asimetrično, 40\% \\ \hline \hline
  1 & 96.0 & 95.3 & 94.6 \\
...
Za sve tri inačice skupa podataka CIFAR-10, modeli učeni uz stopu konzistencije iznosa $5$ postižu najvišu točnost.\ 
Dakle, izgleda da odabir iznosa stope konzistencije ne ovisi nužno o konkretnoj inačici skupa podataka.\ Na temelju ovih rezultata, potvrđujemo fiksiranje stope konzistencije na iznos $5$ te time dolazimo do konačne konfiguracije hiperparametara koju smo koristili pri usporedbi sa stanjem tehnike.\ 
...
Konkretno, algoritam SOP+ osim osnovnog gubitka dodatno koristi konzistencijski gubitak i gubitak ravnoteže razreda.\ Pritom oba gubitka imaju zasebne hiperparametre: stopu konzistencije odnosno stopu ravnoteže razreda.\ 
U osnovnoj konfiguraciji algoritma SOP+, stopa konzistencije je postavljena na iznos $0.9$, dok je stopa ravnoteže razreda postavljena na iznos $0.1$.\ 
...
U tablici~\ref{tbl:usporedba_sop_gubitak}, stupac \textit{Stopa konzistencije} predstavlja korištenu stopu konzistencije, stupac \textit{Stopa ravnoteže razreda} predstavlja korištenu stopu ravnoteže razreda, a stupac \textit{Točnost [\%]} ponovno predstavlja točnost modela na čistom skupu za ispitivanje skupa CIFAR-10.\ 

\pagebreak

\begin{table}[htb]
  \caption{Točnost modela učenih algoritmom SOP+ ovisno o stopi konzistencije te stopi ravnoteže razreda.}
  \label{tbl:usporedba_sop_gubitak}
  \centering
  \begin{tabular}{ll||c}
  Stopa konzistencije & Stopa ravnoteže razreda & Točnost [\%] \\ \hline \hline
  0.9 & 0 & \textbf{96.39} \\
  1 & 0 & 96.28 \\ \hline
  0 & 0.1 & 93.93 \\
  0 & 1 & 93.91 \\ \hline
...
Vidimo da model učen uz stopu konzistencije iznosa $0.9$ te bez komponente gubitka ravnoteže razreda postiže najvišu točnost iznosa $96.39\%$.\ 
Model učen uz osnovnu konfiguraciju postiže neznatno nižu točnost, dok model učen uz stopu ravnoteže razreda iznosa $0.1$ te bez komponente konzistencijskog gubitka postiže točnost za $2.46\%$ nižu od točnosti najboljeg modela.\ 
...
Algoritam ILL osim osnovnog gubitka dodatno koristi i konzistencijski gubitak.\ Za razliku od algoritma SOP+, stopa konzistencije je kod algoritma ILL fiksirana na iznos $1$.\ 
...
\begin{table}[htb]
  \caption{Točnost modela učenih algoritmom ILL ovisno o stopi konzistencije.}
...
Vidimo da model učen bez komponente konzistencijskog gubitka postiže najvišu točnost.\ Ipak, razlika u točnosti je neznatna: samo $0.06\%$.\ 
...
Dodajmo sada komponentu konzistencijskog gubitka.\ Pritom stopu konzistencije fiksiramo na iznos $1$, a jake augmentacije definiramo kao slabe augmentacije uz dodanu augmentaciju AutoAugment.\ 
...
Ključne mjere dobrote za eksperimente s napadima umetanjem stražnjih vrata su točnost na čistom skupu za ispitivanje te stopa uspješnosti napada (ASR) izračunata na potpuno zatrovanoj inačici skupa za ispitivanje.\ 
Pritom želimo maksimizirati točnost, ali i minimizirati stopu uspješnosti napada.\ 
...
Konkretno, koristili smo konstantnu stopu konzistencije iznosa $1$, a jake augmentacije uključuju slabe augmentacije, augmentaciju AutoAugment te augmentaciju nasumičnog brisanja.\ 
...
Stupac \textit{Točnost [\%]} predstavlja točnost modela na čistom skupu za ispitivanje skupa CIFAR-10, a stupac \textit{ASR [\%]} predstavlja stopu uspješnosti napada izračunatu na potpuno zatrovanoj inačici skupa za ispitivanje.\ 
Najbolji rezultati za oba stupca su podebljani.\ 
...
\begin{table}[htb]
  ...
  ASD & 92.1 & 3.0 \\ \hline
  VIBE & 94.4 & 0.6 \\
  VIBE + CL & \textbf{94.8} & \textbf{0.5} \\
  \end{tabular}
\end{table}

\pagebreak

Možemo vidjeti da osnovna inačica okvira VIBE postiže višu točnost, ali i nižu stopu uspješnosti napada u usporedbi s preostalim algoritmima obrane.\ 
Pritom vrijedi napomenuti da algoritam ABL postiže višu točnost te podjednaku ili nižu stopu uspješnosti napada od algoritama DBD i ASD.\ 
Dodavanjem komponente konzistencijskog gubitka, dodatno poboljšavamo performanse okvira VIBE.\ Konkretno, postižemo povećanje točnosti iznosa $0.4\%$, kao i smanjenje stope uspješnosti napada iznosa $0.1\%$.\ 
...
\begin{table}[htb]
  ...
  ASD & 93.4 & 1.0 \\ \hline
  VIBE & 94.4 & 3.1 \\
  VIBE + CL & \textbf{94.5} & \textbf{0.7} \\
  \end{tabular}
\end{table}

U ovom slučaju, osnovna inačica okvira VIBE postiže višu točnost, ali ne i nižu stopu uspješnosti napada u usporedbi s preostalim algoritmima obrane.\ 
Konkretno, algoritam ASD postiže za $2.1\%$ nižu stopu uspješnosti napada u usporedbi s osnovnom inačicom okvira VIBE.\ 
Kao i u prethodnom eksperimentu, dodavanjem konzistencijskog gubitka poboljšavamo performanse okvira VIBE.\ Pritom postižemo povećanje točnosti iznosa $0.1\%$, ali i smanjenje stope uspješnosti napada iznosa čak $2.4\%$.\ 
...
\begin{table}[htb]
  ...
  ASD & 93.3 & 1.2 \\ \hline
  VIBE & 94.5 & 1.0 \\
  VIBE + CL & \textbf{94.8} & 0.6 \\
  \end{tabular}
\end{table}

\pagebreak

Kao i u prethodnom eksperimentu, osnovna inačica okvira VIBE postiže višu točnost, ali ne i nižu stopu uspješnosti napada u usporedbi s preostalim algoritmima obrane.\ 
U ovom slučaju, algoritam DBD postiže za $0.6\%$ nižu stopu uspješnosti napada u usporedbi s osnovnom inačicom okvira VIBE.\ 
Dodavanjem komponente konzistencijskog gubitka, ponovno poboljšavamo performanse okvira VIBE.\ Konkretno, postižemo povećanje točnosti iznosa $0.4\%$, kao i smanjenje stope uspješnosti napada iznosa $0.4\%$.\ 
Iako okvir VIBE s konzistencijskim gubitkom u ovom eksperimentu ima najvišu točnost, algoritam DBD i dalje postiže najnižu stopu uspješnosti napada.\ 

Dakle, zaključujemo da dodavanje konzistencijskog gubitka okviru VIBE vodi do povećanja točnosti, kao i do smanjenja stope uspješnosti napada.\ 
Pritom je smanjenje najveće kod napada Blend za koji osnovni okvir VIBE ima relativno visoku stopu uspješnosti napada.\ 
...
U tablici~\ref{tbl:trovanje_ill}, stupac \textit{Stopa trovanja [\%]} predstavlja korištenu stopu trovanja, stupac \textit{Točnost [\%]} ponovno predstavlja točnost modela na čistom skupu za ispitivanje skupa CIFAR-10, a stupac \textit{ASR [\%]} predstavlja stopu uspješnosti napada izračunatu na potpuno zatrovanoj inačici skupa za ispitivanje.\  
...
Prema iznosu stope uspješnosti napada, vidimo da napad uz stopu trovanja iznosa $1\%$ nije uspio.\ Drugim riječima, ovdje algoritam ILL služi kao uspješna obrana od napada umetanjem stražnjih vrata.\ 
...
Kao i inače, stupac \textit{Točnost [\%]} predstavlja točnost modela na čistom skupu za ispitivanje skupa CIFAR-10, a stupac \textit{ASR [\%]} predstavlja stopu uspješnosti napada izračunatu na potpuno zatrovanoj inačici skupa za ispitivanje.\  
...
\begin{table}[htb]
  ...
  Čvrste & 1 & 94.7 & 100 \\
  Čvrste & 1000 & 94.5 & 100 \\ \hline
  Meke & 1 & \textbf{94.8} & 100 \\ 
  Meke & 1000 & 94.5 & 100 \\ 
  \end{tabular}
\end{table}
...
Nažalost, na temelju iznosa stope uspješnosti napada, vidimo da prva inačica hibridnog okvira nije uspješna kao obrana od napada umetanjem stražnjih vrata.\ 
...
Možemo vidjeti da model učen uz normalizaciju matrice šuma po recima i stupcima te hiperparametar temperature iznosa $10$ sada postiže najvišu točnost.\ Stopa uspješnosti napada pritom je podjednaka za sve konfiguracije hiperparametara.\ 
