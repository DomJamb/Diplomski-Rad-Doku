...
Kroz vrijeme, razvili su se brojni algoritmi za obranu modela od zatrovanih~\cite{li2021anti, huang2022backdoor, gao2023backdoor} odnosno zašumljenih~\cite{liu2022robust, chen2024imprecise} podataka.\ Ipak, većina radova se fokusira na samo jedan od ovih problema, a ne na razvoj algoritma koji se može nositi s oba problema.\ 
