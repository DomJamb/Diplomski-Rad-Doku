...
\begin{table}[htb]
  \caption{Točnost modela učenih okvirom VIBE s konzistencijskim gubitkom ovisno o iznosu stope konzistencije.}
...
\begin{table}[htb]
  \caption{Točnost modela učenih okvirom VIBE s augmentacijom nasumičnog brisanja ovisno o iznosu stope konzistencije.}
...
\begin{table}[htb]
  \caption{Točnost modela učenih okvirom VIBE s konzistencijskim gubitkom na različitim inačicama skupa CIFAR-10 ovisno o iznosu stope konzistencije.}
