...
Kao što možemo vidjeti, algoritam ILL postiže najvišu točnost pri učenju na čistom skupu CIFAR-10.\ Algoritam SOP+ postiže podjednaku točnost kao i algoritam ILL, dok okvir VIBE postiže za $0.6\%$ nižu točnost.\ 
Usporedbom redaka CE i CE + CL, vidimo da dodavanje konzistencijskog gubitka povećava točnost nadziranog učenja za $1.1\%$.\ Zanimljivo je da algoritmi ILL te SOP+ postižu bolju točnost čak i od nadziranog učenja s konzistencijskim gubitkom.\ 
...
Konkretno, uz stopu šuma iznosa $20\%$, algoritam SOP+ postiže najvišu točnost.\ Algoritam ILL podjednake je točnosti, dok okvir VIBE postiže za $0.7\%$ nižu točnost.\ 
Iako se nadzirano učenje pokazuje kao najlošije u ovom postavu, zanimljivo je da dodavanjem konzistencijskog gubitka možemo postići točnost za samo $1.1\%$ nižu u usporedbi sa stanjem tehnike.\ 
...
Uz stopu šuma iznosa $50\%$, algoritam ILL postiže najvišu točnost.\ Algoritam SOP+ u ovom slučaju je podjednake točnosti, dok okvir VIBE postiže za $0.9\%$ nižu točnost.\ U usporedbi sa stanjem tehnike, ovaj postav predstavlja najgori slučaj za okvir VIBE.\ 
...
Kada govorimo o postavu sa stopom šuma iznosa $80\%$, okvir VIBE postiže najvišu točnost.\ Pritom je točnost VIBE-a za $1.1\%$ viša u odnosu na algoritam SOP+, odnosno za $0.4\%$ viša u odnosu na algoritam ILL.\ 
Kod ovog postava, nadzirano učenje postiže veoma nisku točnost iznosa $26.7\%$.\ Iako dodavanjem konzistencijskog gubitka točnost možemo povećati za čak $49.8\%$, ovaj rezultat je i dalje značajno lošiji od rezultata okvira VIBE.\ 
Zanimljivo je da rezultati stanja tehnike za ovaj postav odudaraju od rezultata iz originalnih radova za $0.8\%$ u slučaju algoritma SOP+, odnosno za $0.4\%$ u slučaju algoritma ILL.\

Uočimo da povećavanjem stope šuma s $20\%$ na $80\%$ kod okvira VIBE gubimo samo $1.3\%$ točnosti, dok kod algoritama SOP+ te ILL gubimo $3.1\%$ odnosno $2.3\%$ točnosti.\ 
...
Vidimo da u ovom slučaju okvir VIBE postiže najvišu točnost.\ Pritom je točnost okvira VIBE za $0.9\%$ viša u odnosu na algoritam SOP+, odnosno za $33.4\%$ viša u odnosu na algoritam ILL.\ 
...
Dodatno, vidimo da i u ovom slučaju dodavanje konzistencijskog gubitka nadziranom učenju značajno povećava točnost.\ Konkretno, ovdje postižemo povećanje točnosti iznosa $15.8\%$.\ 
...
Pritom dobiveni model postiže točnost za $1.2\%$ višu od točnosti najboljeg modela učenog okvirom VIBE bez konzistencijskog gubitka.\ 
...
U usporedbi s najboljim modelom iz tablice~\ref{tbl:usporedba_lr_num_iter_con_loss}, novi najbolji model postiže za $0.3\%$ višu točnost.\ 
...
Naučeni model postiže za $0.6\%$ višu točnost u usporedbi s prethodno najboljim modelom iz tablice~\ref{tbl:usporedba_lr_num_iter_con_loss_lr_scheduler}.\ 
...
Model učen uz osnovnu konfiguraciju postiže neznatno nižu točnost, dok model učen uz faktor gubitka ravnoteže razreda iznosa $0.1$ te bez komponente konzistencijskog gubitka postiže točnost za $2.5\%$ nižu od točnosti najboljeg modela.\ 
...
Vidimo da model učen bez komponente konzistencijskog gubitka postiže najvišu točnost.\ Ipak, razlika u točnosti je neznatna: samo $0.1\%$.\ 
...
Konkretno, učenje na asimetrično zašumljenoj inačici skupa CIFAR-10 uz stopu šuma iznosa $40\%$ rezultira modelom čija je točnost za $18.5\%$ niža od točnosti modela učenog na čistom skupu.\ 
...
Konkretno, kraćim učenjem možemo smanjiti razliku u točnosti modela učenog na čistom skupu te modela učenog na asimetrično zašumljenoj inačici skupa s $18.5\%$ na $5.8\%$, ali ćemo ovo platiti $0.5\%$ nižom točnošću pri učenju na čistom skupu.\  
...
Odabirom učenja $200$ epoha, razliku u točnosti modela učenog na čistom skupu te modela učenog na asimetrično zašumljenoj inačici skupa dodatno smanjujemo s $5.8\%$ na $3.7\%$, ali uz cijenu $0.4\%$ niže točnosti pri učenju na čistom skupu.\ 
...
Dodavanjem komponente konzistencijskog gubitka, dodatno poboljšavamo performanse okvira VIBE.\ Konkretno, postižemo povećanje točnosti iznosa $0.4\%$, kao i smanjenje udjela uspješnih napada iznosa $0.1\%$.\ 
...
Konkretno, algoritam ASD postiže za $2.5\%$ niži udio uspješnih napada u usporedbi s osnovnom inačicom okvira VIBE.\ 
Kao i u prethodnom eksperimentu, dodavanjem konzistencijskog gubitka poboljšavamo performanse okvira VIBE.\ Pritom postižemo povećanje točnosti iznosa $0.2\%$, ali i smanjenje udjela uspješnih napada iznosa čak $2.8\%$.\ 
...
U ovom slučaju, algoritam DBD postiže za $0.4\%$ niži udio uspješnih napada u usporedbi s osnovnom inačicom okvira VIBE.\ 
Dodavanjem komponente konzistencijskog gubitka, ponovno poboljšavamo performanse okvira VIBE.\ Konkretno, postižemo povećanje točnosti iznosa $0.4\%$, kao i smanjenje udjela uspješnih napada iznosa $0.2\%$.\ 
