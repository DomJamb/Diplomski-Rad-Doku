...
Pritom jake augmentacije uključuju slabe augmentacije te augmentaciju AutoAugment, a stopa konzistencije je postavljena na iznos $1$.\ Pogledajmo kako se točnost modela učenog okvirom VIBE s konzistencijskim gubitkom mijenja ovisno o broju iteracija učenja te iznosu stope učenja.\ 
...
Pogledajmo kako se točnost modela učenog okvirom VIBE s konzistencijskim gubitkom i strategijom kosinusnog kaljenja mijenja ovisno o broju iteracija učenja te iznosu stope učenja.\ 
...
\subsection{Validacija formulacije gubitka stanja tehnike}
